...
class __TwigTemplate_be83d810e9edfa5db0c4b94285c1e2e22d8f32954b4ffa17c407bb9b690db07c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "sites/all/themes/bootstrap/templates/input/input--button.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/drupal-9.2.3/sites/all/themes/bootstrap/templates/input/input--button.html.twig");
    }
